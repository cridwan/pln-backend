...
class PartExport implements FromQuery, WithMapping, WithColumnWidths, WithStyles, WithDrawings, WithCustomStartCell, WithTitle
{
    ...
    {
        return Part::query()->with('globalUnit');
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('D5', 'NO DRAWING');
