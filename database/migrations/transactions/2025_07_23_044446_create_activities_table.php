...
return new class extends Migration {
    ...
    {
        Schema::connection(ConnectionEnum::TRANSACTION->value)->create('activities', function (Blueprint $table) {
            $table->uuid()->primary();
    ...
    {
        Schema::connection(ConnectionEnum::TRANSACTION->value)->dropIfExists('activities');
    }
};
